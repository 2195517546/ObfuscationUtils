...
/**
 * @author Uiloalxise
 * @ClassName PerPixelObfuscation
 * @Description TODO
 */
public class PerPixelObfuscation extends PixelObfuscation {
    public PerPixelObfuscation(ImageData image, String key) {
		super(image, key);
	}

	public PerPixelObfuscation(int[] pixels, int width, int height, String key) {
