...
/**
 * @author Uiloalxise
 * @ClassName PicEncryptObfuscation
 * @Description TODO
 */
public abstract class PicEncryptObfuscation extends ImageObfuscation{
    protected double key;

	public PicEncryptObfuscation(ImageData image, double key) {
		this(image.getPixels(), image.getWidth(), image.getHeight(), key);
	}

	public PicEncryptObfuscation(int[] pixels, int width, int height, double key) {
